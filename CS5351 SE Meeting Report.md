...
主题: 讨论项目情况，任务进度，前后端结对编程

会议时间: 2025年10月20日 19:00 

结束时间：2025.10.20 21:00

### 会议内容

后端完成网页读取GitHub workflow数据的demo
...
- 前端
  ...
  修改bug: scrum userstory 的point

  修改bug: GitHub只有import 没有同步
